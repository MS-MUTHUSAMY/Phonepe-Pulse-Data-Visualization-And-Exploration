...
if option == 'All India':
    ...
    try:
        ...
        st.header("where the aggregated_user data from 2022 (Qtr 2,3,4) to 2023 (Qtr 1,2,3) are not same like previous year Phonepe Pluse data, so can't feed data to sql and can't visualize ")          
